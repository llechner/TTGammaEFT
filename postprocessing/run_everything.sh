submitCondor.py $1 --dpm --maxRetries 5 --resubmitFailedJobs --discSpace 5000 --execFile submit_on_lxplus.sh --output /afs/cern.ch/work/l/llechner/public/condor_logs/mc16/   --queue testmatch nanoPostProcessing_Summer16_private.sh
#submitCondor.py $1 --dpm --maxRetries 5 --resubmitFailedJobs --discSpace 5000 --execFile submit_on_lxplus.sh --output /afs/cern.ch/work/l/llechner/public/condor_logs/data16/ --queue testmatch nanoPostProcessing_Run2016_14Dec2018.sh

submitCondor.py $1 --dpm --maxRetries 5 --resubmitFailedJobs --discSpace 5000 --execFile submit_on_lxplus.sh --output /afs/cern.ch/work/l/llechner/public/condor_logs/mc17/   --queue testmatch nanoPostProcessing_Fall17_private.sh
#submitCondor.py $1 --dpm --maxRetries 5 --resubmitFailedJobs --discSpace 5000 --execFile submit_on_lxplus.sh --output /afs/cern.ch/work/l/llechner/public/condor_logs/data17/ --queue testmatch nanoPostProcessing_Run2017_14Dec2018.sh

submitCondor.py $1 --dpm --maxRetries 5 --resubmitFailedJobs --discSpace 5000 --execFile submit_on_lxplus.sh --output /afs/cern.ch/work/l/llechner/public/condor_logs/mc18/   --queue testmatch nanoPostProcessing_Autumn18_private.sh
#submitCondor.py $1 --dpm --maxRetries 5 --resubmitFailedJobs --discSpace 5000 --execFile submit_on_lxplus.sh --output /afs/cern.ch/work/l/llechner/public/condor_logs/data18/ --queue testmatch nanoPostProcessing_Run2018_14Dec2018.sh
