...
class Configuration:
    def __init__( self, model_name, MG260=False ):
        ...
        # Load model
        model_file = os.path.expandvars( "$CMSSW_BASE/python/TTGammaEFT/Generation/parameters.py" )
        ...
        # MG file locations
        self.data_path = os.path.expandvars( '$CMSSW_BASE/src/TTGammaEFT/Generation/data' )
