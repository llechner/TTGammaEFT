...
from TTGammaEFT.Tools.user import postprocessing_directoryRun2018 as postprocessing_directory
...
allSamples_Data25ns  = []
for pd in allSamples:
    vars()[ pd + '_Run2018' ] = getDPMSample( pd, 'Run2018', lumi*1000, dirs, redirector = redirector )
