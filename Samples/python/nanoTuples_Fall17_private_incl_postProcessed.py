...
postprocessing_directory = postprocessing_locations.MC2017_incl
...
TTG_NoFullyHad_fnal_17 = Sample.fromDPMDirectory(name="TTG",              treeName="Events", redirector=redirector, isData=False, color=color.TTG,             texName="t#bar{t}#gamma",    directory=directories["TTG_NoFullyHad_fnal"], noCheckProxy=True)
