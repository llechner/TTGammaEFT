...
for FILE in ${cardpath}/*.txt; do
    ...
    echo "python signalRegionPlot_sorted.py $@ --carddir ${carddir} --cardfile ${card} --year 2016 --postFit"
    python signalRegionPlot_sorted.py $@ --carddir ${carddir} --cardfile ${card} --year 2016 --postFit &
    echo "python signalRegionPlot_sorted.py $@ --carddir ${carddir} --cardfile ${card} --year 2016"
    python signalRegionPlot_sorted.py $@ --carddir ${carddir} --cardfile ${card} --year 2016
