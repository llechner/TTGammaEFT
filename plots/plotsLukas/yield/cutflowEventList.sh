nohup krenew -t -K 10 -- bash -c "python cutflowEventList.py --selection nLepTight1-e-nLepVeto1-nJet4p --useCorrectedIsoVeto" &
nohup krenew -t -K 10 -- bash -c "python cutflowEventList.py --selection nLepTight1-mu-nLepVeto1-nJet4p --useCorrectedIsoVeto" &

nohup krenew -t -K 10 -- bash -c "python cutflowEventList.py --selection nLepTight1-e-nLepVeto1-nJet4p-nBTag1p --useCorrectedIsoVeto" &
nohup krenew -t -K 10 -- bash -c "python cutflowEventList.py --selection nLepTight1-mu-nLepVeto1-nJet4p-nBTag1p --useCorrectedIsoVeto" &

nohup krenew -t -K 10 -- bash -c "python cutflowEventList.py --selection nLepTight1-e-nLepVeto1-nJet4p-nBTag1p-nPhoton1p-photoncat0 --useCorrectedIsoVeto" &
nohup krenew -t -K 10 -- bash -c "python cutflowEventList.py --selection nLepTight1-mu-nLepVeto1-nJet4p-nBTag1p-nPhoton1p-photoncat0 --useCorrectedIsoVeto" &

nohup krenew -t -K 10 -- bash -c "python cutflowEventList.py --selection nLepTight1-e-nLepVeto1-nJet4p-nBTag1p-nPhoton1p-photoncat1 --useCorrectedIsoVeto" &
nohup krenew -t -K 10 -- bash -c "python cutflowEventList.py --selection nLepTight1-mu-nLepVeto1-nJet4p-nBTag1p-nPhoton1p-photoncat1 --useCorrectedIsoVeto" &

nohup krenew -t -K 10 -- bash -c "python cutflowEventList.py --selection nLepTight1-e-nLepVeto1-nJet4p-nBTag1p-nPhoton1p-photoncat2 --useCorrectedIsoVeto" &
nohup krenew -t -K 10 -- bash -c "python cutflowEventList.py --selection nLepTight1-mu-nLepVeto1-nJet4p-nBTag1p-nPhoton1p-photoncat2 --useCorrectedIsoVeto" &
